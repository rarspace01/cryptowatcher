...
CMD wget https://github.com/rarspace01/cryptowatcher/releases/latest/download/cryptowatcher-1.0.0-runner.jar -O cryptowatcher.jar && chmod +x cryptowatcher.jar && ./jre/bin/java -XX:+HeapDumpOnOutOfMemoryError -Dquarkus.mongodb.connection-string=${MONGO_URI} -jar cryptowatcher.jar